...
const ViewBranchReport = () => {
  ...
  const { setShowEdit, showNav } = ItemContext();
  const history = async () => {
  ...
  return (
    <div className="flex w-screen">
      ...
      <div className="w-[80%] px-10 py-6 flex flex-col gap-10 overflow-y-scroll">
        ...
        <div className="flex w-full justify-between gap-4">
          <div className="w-80 h-fit border lg:flex lg:gap-6 sm:gap-2 rounded-lg px-6 py-4">
            ...
            <div className="flex flex-col gap-6 inter">
              <h4 className="font-normal sm:text-[14px] lg:text-[16px] sm:pt-4 sm:text-gray-500">
                Total Sales Made
              </h4>
          ...
          <div className="w-80 h-fit border lg:flex lg:gap-6 sm:gap-2rounded-lg px-6 py-4">
            ...
            <div className="flex flex-col gap-6 inter">
              <h4 className="font-medium sm:text-[14px] lg:text-[16px] sm:pt-4 sm:text-gray-500">
                Date Created
              </h4>
