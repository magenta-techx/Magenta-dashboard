      ...
      <div className="lg:w-[80%] xs:w-[100%]  overflow-x-hidden sm:px-8 sm:py-6 h-[92%] sm:h-screen  overflow-y-scroll ">
        ...
        <section>
          <div className="wrap sm:justify-between flex sm:flex-row flex-col gap-4 lg:justify-between py-4">
            <h1 className="font-medium sm:text-xl sm:font-bold lg:text-2xl pt-3 albert">
              Transaction History
            </h1>
          ...
          <button
            ...
            className=" bg-[#4E00AD] text-white disabled:text-gray-400 disabled:font-normal disabled:bg-[#E2E6EE] flex  w-fit rounded-xl p-3 lg:mt-4 sm:mt-4 "
          >
